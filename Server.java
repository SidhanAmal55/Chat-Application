...
public class Server implements ActionListener {
	...
	Server() {
		...
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("gaitonde.jpeg"));
		...
		ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("video (1).png"));
		...
		ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("phone (1).png"));
